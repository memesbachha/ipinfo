...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        Coded By MEMES BACHHA       |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|    https://github.com/memesbachha  |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " MEMES BACHHA")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 21/06/2021")
       slowprint ("\033[1;33m" + "         [+] Instagram     =>\033[1;36m" + " memesbachha")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " memesbachha")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "          [+]  MEMESBACHHA  [+]            ")
       slowprint ("\033[1;91m -----------------------------------------------")
